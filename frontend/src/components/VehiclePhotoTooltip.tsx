...
interface VehiclePhotoTooltipProps {
  ...
  // Optional — when present, the Vehículo/Propietario blocks inside the
  // popover become links to their own ficha (EntityLink falls back to plain
  // text with no id, so omitting these changes nothing for existing callers).
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-gray-900 font-medium truncate">
                    <EntityLink to={`/vehiculos/${vehicleId}`} id={vehicleId}>{vehicleName}</EntityLink>
                  </p>
                ...
                <div className="flex items-start gap-2 pt-2 border-t border-gray-100">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-sm text-gray-900 truncate">
                      <EntityLink to={`/propietarios/editar/${ownerId}`} id={ownerId} requireAdmin>{ownerName}</EntityLink>
                    </p>
                    {ownerPhone && (
                      <p className="text-xs text-gray-500 flex items-center gap-1">
